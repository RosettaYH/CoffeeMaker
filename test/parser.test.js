...
const syntaxErrors = [
	...
	["class declaration with no name", "keurig {create(self, put name, regular birthDate) {this.name = name this.birthDate = birthDate} cup put name -> (self, put x) {x}}", /Line 1, col 8/],
	["class declaration with no body", "keurig Person", /Line 1, col 14/],
	["class declaration with no create", "keurig Person {cup put name -> (self, put x) {x}}", /Line 1, col 16/],
	["function declaration with no name", "cup regular -> (regular z) {complete 3 - z}", /Line 1, col 13/],
];
